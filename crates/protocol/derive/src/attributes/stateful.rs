    ...
    L2P: L2ChainProvider + Debug + Send,
{
    async fn prepare_payload_attributes(
        ...
        info!(target: "attributes_builder", "l2_parent.l1_origin.number:{} and epoch.number:{}", l2_parent.l1_origin.number, epoch.number);
        ...
        info!(target: "attributes_builder", "deposit_transactions: {:?}", deposit_transactions);
