...
impl<T: CommsClient> OracleBlobProvider<T> {
    ...
    async fn get_blob(
        ...
        info!("get commitment preimagekey {:?}", PreimageKey::new(*blob_hash.hash, PreimageKeyType::Sha256));
        self.oracle
        ...
        for i in 0..FIELD_ELEMENTS_PER_BLOB {
            ...
            info!("get blob preimagekey {:?}", PreimageKey::new(*keccak256(field_element_key), PreimageKeyType::Blob));
