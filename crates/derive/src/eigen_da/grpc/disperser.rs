use crate::eigen_da::grpc::common;
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DispersePaidBlobRequest {
    ...
    pub payment_header: ::core::option::Option<common::PaymentHeader>,
    /// signature of payment_header
    #[prost(bytes = "vec", tag = "4")]
    pub payment_signature: ::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod disperser_server {
    ...
    pub trait Disperser: Send + Sync + 'static {
        ...
        type DisperseBlobAuthenticatedStream: tonic::codegen::tokio_stream::Stream<
                Item = Result<super::AuthenticatedReply, tonic::Status>,
            >
            + Send
            + 'static;
        /// DisperseBlobAuthenticated is similar to DisperseBlob, except that it requires the
        ...
        ) -> Result<tonic::Response<super::BlobStatusReply>, tonic::Status>;
        /// This retrieves the requested blob from the Disperser's backend.
        /// This is a more efficient way to retrieve blobs than directly retrieving
        /// from the DA Nodes (see detail about this approach in
        /// api/proto/retriever/retriever.proto).
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/disperser.Disperser/DisperseBlobAuthenticated" => {
                    ...
                    impl<
                        T: Disperser,
                    > tonic::server::StreamingService<super::AuthenticatedRequest>
                    for DisperseBlobAuthenticatedSvc<T> {
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                tonic::Streaming<super::AuthenticatedRequest>,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Disperser>::disperse_blob_authenticated(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/disperser.Disperser/RetrieveBlob" => {
                    ...
                    impl<
                        T: Disperser,
                    > tonic::server::UnaryService<super::RetrieveBlobRequest>
    ...
    impl<T> Clone for DisperserServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "disperser.Disperser";
    impl<T> tonic::server::NamedService for DisperserServer<T> {
